package SequencialsCondicionalsIteratius.Condicionals;
...
public class pt3NouCursV2 {
    public static void main(String[] args) {
        ...
        int plantesLliures = (int) placesLliures / aules / alumnes;

        if (alumnes > 0 && aules > 0 && plantes > 0 && matricules > 0){
            if (alumnes * aules * plantes > matricules){
                System.out.println("A l'institut sobren " + (int) plantesLliures + " plantes");
            }else {
